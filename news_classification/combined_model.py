...
class CombinedModel(torch.nn.Module):
    ...
    def learn(self, train_iter, dev_X, dev_y1, dev_y2, test_X, test_y1, test_y2, cfg):
        ...
        for epoch in range(cfg.epochs):
            ...
            all_dev_r2.append(dev_r2.float())
            ...
            if min_loss - dev_loss.item() > 0.0001:
                ...
                best_epoch = epoch
                torch.save(self, os.path.join(cfg.training_dir, f"model_{cfg.input_name}.pt"))
            else:
                epochs_no_improve += 1
